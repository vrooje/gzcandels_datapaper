...
\begin{equation}
   w_{00}= \left\{
    \begin{array}{l l}
      \max \left(1.1^n, 0.01\right)       & \text{ if } n < 0 \\
      \min \left(1.05^n, 3 \right) & \text{ if } n \geq 0.\\
    \end{array} \right.
