...
\begin{table}
 ...
 \hline
\multicolumn{1}{l}{ID} &
\multicolumn{1}{c}{$f_{\rm smooth}$} &
\multicolumn{1}{c}{\musb} 
\\ 
\hline
\hline
$\ldots$    \\
 COS\_1277  &  0.73 & 23.34\\
 COS\_6446  &  0.94 &  22.34\\
 COS\_9985  &  0.83 & 23.35\\
COS\_10079  &  0.67 & 24.20\\
COS\_24473  &  0.72 & 23.03\\
$\ldots$    \\
 \hline
 \end{tabular}
 \caption{Galaxies identified in Galaxy Zoo CANDELS as ``smooth'', having $1 \leq z \leq 3$ and $\mmusb \leq 24.5$~mag~arcsec$^{-2}$ and bulge-to-total ratio less than 50 per cent (flux-summed across $IJH$ bands) according to the MegaMorph project \citep[][B. H\"au\ss ler et al., in preparation]{haeussler13}.
\label{table:smooth_disks}}
\end{table}
