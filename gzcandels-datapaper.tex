...
Janine Pforr$^{LAM}$,
Stijn Wuyts$^{BATH}$,
{\builderUC Eric F. Bell$^{99}$,}
Marco Castellano$^{INAF}$
{\builderUC Tomas Dahlen$^{99}$,} 
Avishai Dekel$^{RACAH}$
{\builderUC Jamie Ownsworth$^{99}$,}
{\builderUC Sandra M. Faber$^{99}$,} %UCO/Lick
{\builderUC Steven L. Finkelstein$^{99}$,} 
{\builderUC Adriano Fontana$^{99}$,}
{\builderUC Audrey Galametz$^{99}$,}
{\builderUC Ruth Gr\"utzbauch$^{99}$,} 
{\builderUC David Koo$^{99}$,} %UCSC
{\builderUC Jennifer Lotz$^{99}$,} %ST
{\builderUC Bahram Mobasher$^{99}$,} %UCR / check
{\builderUC Mark Mozena$^{99}$,}
...
$^{MOKC}$Department of Physics \& Astronomy, University of Missouri-Kansas City, 5110 Rockhill Rd., Kansas City, MO 64110, USA\\
...
$^{JHU}$Department of Physics and Astronomy, The Johns Hopkins University, Baltimore, MD 21218, USA\\
