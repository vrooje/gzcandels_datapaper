...
\author[Simmons et al.]{\parbox[t]{16cm}{B. D. Simmons$^{1,2,3,4}$\thanks{E-mail: bdsimmons@ucsd.edu}\footnote{Einstein Fellow}, 
Chris Lintott$^{1,3}$, 
Kyle W. Willett$^{5}$, 
Karen L. Masters$^{2,4}$, 
Robert C. Nichol$^{2,4}$, 
...
{\noteb (Note: author order not fixed, list not necessarily complete, please send me your affiliations)}
%
\vspace{0.1in} }\\
