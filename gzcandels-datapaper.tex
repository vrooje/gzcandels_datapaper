...
After the classification of each image is finished, the classifier is asked "{\notebsm Do you want to discuss this galaxy?}" If the classifier selects "No", a new image is shown for classification. If the classifier selects yes, a new window opens with a discussion page focused on the image they have just classified. Within this part of the Galaxy Zoo software, called Talk, users may ask questions and make comments on specific images, or engage in more general discussions. Users may also "tag" images and discussions using a format identical to Twitter's hashtag system. Some of these tags were used in the pre-analysis of Galaxy Zoo CANDELS data, on which more details are given in Section \ref{sec:dunno} below.
...
\hline
\hline						
00    & {\it Is the galaxy simply smooth   }  & smooth           & 01 \\
      & {\it and rounded, with no sign of  }  & features or disk & 02 \\
      & {\it a disk?                       }  & star or artifact & {\bf end} \\
      \hline
01    & {\it How rounded is it?            }  & completely round & 16 \\
      & {\it                               }  & in between       & 16 \\
      & {\it                               }  & cigar-shaped     & 16 \\
      \hline
02    & {\it Does the galaxy have a    }  & yes                  & 03 \\
      & {\it mostly clumpy appearance? }  & no                   & 09 \\
      \hline
03    & {\it How many clumps           }  & 1                    & 07 \\
      & {\it are there?                }  & 2                    & 05 \\
      & {\it                           }  & 3                    & 04 \\
      & {\it                           }  & 4                    & 04 \\
      ...
      & {\it                           }  & can't tell           & 04 \\
      \hline
04    & {\it Do the clumps appear in   }  & cluster              & 05 \\
      & {\it a straight line, a chain  }  & spiral               & 05 \\
      & {\it or a cluster?             }  & straight line        & 05 \\
      & {\it                           }  & chain                & 05 \\
      \hline
05    & {\it Is there one clump which is       }  & yes          & 06 \\
      & {\it clearly brighter than the others? }  & no           & 07 \\
      \hline
06    & {\it Is the brightest clump    }  & yes                  & 07 \\
      & {\it central to the galaxy?    }  & no                   & 16 \\
      \hline
07    & {\it Does the galaxy           }  & yes                  & 08 \\
      & {\it appear symmetrical?       }  & no                   & 08 \\
      \hline
08    & {\it Do the clumps appear to be       }  & yes           & 16 \\
      & {\it embedded within a larger object? }  & no            & 16 \\
      \hline
09    & {\it Could this be a disk viewed   }  & yes              & 10 \\
      & {\it edge-on?                      }  & no               & 11 \\
      \hline
10    & {\it Does the galaxy have a        }  & yes              & 16 \\
      & {\it bulge at its centre?          }  & no               & 16 \\
      \hline
11    & {\it Is there a sign of a bar      }  & bar              & 12 \\
      & {\it feature through the centre    }  & no bar           & 12 \\
      & {\it of the galaxy?                }                          \\
      \hline
12    & {\it Is there any sign of a        }  & spiral           & 13 \\
      & {\it spiral arm pattern?           }  & no spiral        & 15 \\
      \hline
13    & {\it How tightly wound do the      }  & tight            & 14 \\
      & {\it spiral arms appear?           }  & medium           & 14 \\
      & {\it                               }  & loose            & 14 \\
      \hline
14    & {\it How many spiral arms          }  & 1                & 15 \\
      & {\it are there?                    }  & 2                & 15 \\
      & {\it                               }  & 3                & 15 \\
      & {\it                               }  & 4                & 15 \\
...
Figure \ref{fig:classification_basic_info} shows the distribution of total classification counts within the sample. There are peaks at $\sim 20$, $40$, and $80$, consistent with the description above. 
