...
% Maybe list: Avishai Dekel (wants to be included but isn't a builder (?) and hasn't commented on paper yet), Marco Castellano (photometry builder? unclear)
Chris Lintott$^{1}$, 
...
% {\builderUC Yicheng Guo$^{99}$,} % Yicheng says he hasn't done enough on this paper so shouldn't be an author
