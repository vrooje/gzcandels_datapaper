...
Both the CANDELS team and Galaxy Zoo volunteer classifications allow for the flagging of a galaxy as edge-on with a single selection, allowing for direct comparison. Figure \ref{fig:candels_compare}c shows the CANDELS team versus the Galaxy Zoo volunteer classification vote fractions. The two agree very well, with the average vote fraction generally consistent with a 1:1 line. 
