...
% So I *think* the total number of classifications is 2,149,206 but I'm not 100% sure yet.
...
Figure \ref{fig:nclass_subject_hist} shows the distribution of total classification counts within the sample. There are peaks at $\sim 20$, $40$, and $80$, consistent with the description above. 
